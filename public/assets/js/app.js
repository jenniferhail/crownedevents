...
$('.offcanvas-full-screen a').on('click', function() {
    $('.offcanvas-full-screen').foundation('close');
});

//Loading
// $(document).ready(function(){
	// $(".hero-full-screen").hide(0).delay(200).fadeIn(500);
	// $(".content-area, .blog_related, .blog_comments, footer").hide(0).delay(1000).fadeIn(500);
	// $(".wrapper, .wrapper-overview, .index-logos, .fd-bg-white, .fd-product-text, .fd-variants, .site-footer, .homepage-2").hide(0).delay(1500).fadeIn(500);  
// });

// function FadeIn() {
// 	$(".hero-full-screen").hide(0).delay(200).fadeIn(500);
// 	$(".content-area").hide(0).delay(1000).fadeIn(500);
// }
